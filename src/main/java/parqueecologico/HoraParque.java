...
public class HoraParque implements Runnable {
    private final Colectivo colectivo; // Referencia al colectivo para controlar su funcionamiento según el horario del parque
    static int hora = 9;
    static int horaCierre = 17;

    public HoraParque(Colectivo colectivo) {
        // Constructor vacío, no se necesitan atributos para esta clase
    ...
    private void sumarHora(){
        ...
        synchronized (colectivo){
            colectivo.notifyAll(); // Notificar a los hilos que están esperando en el colectivo para que puedan verificar la hora y actuar en consecuencia
        }
    }
